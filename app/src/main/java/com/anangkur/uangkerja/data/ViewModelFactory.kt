...
import com.anangkur.uangkerja.feature.main.history.HistoryTransaksiViewModel
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T  =
        with(modelClass) {
            when {
                ...
                isAssignableFrom(HistoryTransaksiViewModel::class.java) -> HistoryTransaksiViewModel(
                    repository
                )
